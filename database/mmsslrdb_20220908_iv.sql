...
insert  into `userregistration`(`id`,`regNo`,`firstName`,`middleName`,`lastName`,`gender`,`contactNo`,`email`,`password`,`role_id`,`regDate`,`updationDate`,`passUdateDate`) values (3,'13','GMA',NULL,NULL,NULL,NULL,NULL,NULL,2,'2022-09-06 08:28:06',NULL,NULL);
