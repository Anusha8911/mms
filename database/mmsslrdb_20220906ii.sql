...
insert  into `branches`(`id`,`branch_name`) values (3,'Appoinment');
insert  into `branches`(`id`,`branch_name`) values (4,'Discipline');
...
insert  into `registration`(`id`,`recidate`,`devision`,`regno`,`subject`,`title`,`recitype`,`regplace`,`action`,`comment`) values (3,'2022-09-05','CR',13,'1','computer repair','By Normal Post','colombo','Desicion taken & forword','weak');
insert  into `registration`(`id`,`recidate`,`devision`,`regno`,`subject`,`title`,`recitype`,`regplace`,`action`,`comment`) values (34,'2022-09-04','SRS',14,'2','meeting','By Hand','maradana','Sent for Answer','quick');
