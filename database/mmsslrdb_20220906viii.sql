...
insert  into `registration`(`id`,`recidate`,`devision`,`regno`,`subject`,`title`,`recitype`,`regplace`,`action`,`comment`,`branch`,`mainreciver`,`position`) values (1,'2022-08-10','COM',1235,'2','ss','By Hand','sssssssss','Calling for meeting','sssssss','OPS','GMA','MSO');
insert  into `registration`(`id`,`recidate`,`devision`,`regno`,`subject`,`title`,`recitype`,`regplace`,`action`,`comment`,`branch`,`mainreciver`,`position`) values (21,'2022-09-03','CR',11,'2','ee','By Hand','dsdffdsf','Calling for meeting','swwwwwwwwww','Ticketing','GMR','Branch Member');
...
insert  into `userlog`(`id`,`userId`,`userEmail`,`userIp`,`city`,`country`,`loginTime`) values (7,4,'gmr@gmail.com','::1','','','2022-09-07 11:26:38');
...
insert  into `userregistration`(`id`,`regNo`,`firstName`,`middleName`,`lastName`,`gender`,`contactNo`,`email`,`password`,`regDate`,`updationDate`,`passUdateDate`) values (4,'13',NULL,NULL,'gmr',NULL,NULL,'gmr@gmail.com','Test@123','2022-09-06 08:28:06',NULL,NULL);
...
insert  into `userregistration`(`id`,`regNo`,`firstName`,`middleName`,`lastName`,`gender`,`contactNo`,`email`,`password`,`regDate`,`updationDate`,`passUdateDate`) values (8,'1235',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2022-09-07 11:22:57',NULL,NULL);
insert  into `userregistration`(`id`,`regNo`,`firstName`,`middleName`,`lastName`,`gender`,`contactNo`,`email`,`password`,`regDate`,`updationDate`,`passUdateDate`) values (9,'11',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2022-09-07 11:24:05',NULL,NULL);
